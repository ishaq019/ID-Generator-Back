...
const defaultTemplates = [
  ...
  {
    templateName: "Leap Robots ID Card",
    slug: "leap-robots-id-card",
    layoutKey: "leaprobots",
    category: "Office",
    orientation: "vertical",
    isDefault: true,
...

  {
    ...
    frontDesign: {
      ...
      gradient:
        "linear-gradient(160deg, #eff6ff 0%, #ffffff 48%, #dbeafe 100%)",
      borderRadius: 22,
      shadow: true,
      borderColor: "#bfdbfe",
    },
  ...
  },
  {
    ...
    frontDesign: {
      backgroundType: "gradient",
      gradient:
        "linear-gradient(145deg, #111827 0%, #1f2937 55%, #2563eb 100%)",
      borderRadius: 20,
      shadow: true,
      borderColor: "#1f2937",
    },
    ...
    fields: [
      ...
      },
      {
        ...
        side: "back",
        defaultValue:
          "If found, please return this card to the issuing office.",
        x: 25,
        y: 270,
        width: 210,
        height: 70,
  ...
  },
  {
    ...
    frontDesign: {
      backgroundType: "gradient",
      gradient:
        "linear-gradient(160deg, #fef3c7 0%, #ffffff 50%, #fde68a 100%)",
      borderRadius: 22,
      shadow: true,
      borderColor: "#f59e0b",
    },
...
const seedDefaultTemplates = async () => {
  for (const template of defaultTemplates) {
    await Template.findOneAndUpdate({ slug: template.slug }, template, {
      upsert: true,
      new: true,
